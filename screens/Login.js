    ...
    return (
        <View style={styles.container}>
            ...
            <Button
                ...
                buttonStyle={isCreateMode ? { backgroundColor: Colors.yellow} : { backgroundColor: Colors.teal } }
...
const styles = StyleSheet.create({
    ...
    label: { fontSize: 16, fontWeight: "bold", color: Colors.black , marginTop: 10},
    header: { fontSize: 72, fontWeight: "bold", color: Colors.black, alignSelf: "center" },
    logo: {
